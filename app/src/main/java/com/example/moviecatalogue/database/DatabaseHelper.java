...
import com.example.moviecatalogue.database.DatabaseContract.FavoriteColumns;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String SQL_CREATE_TABLE_FAVORITE = String.format("CREATE TABLE %s"
                ...
                FavoriteColumns.ORIGINAL_TITLE,
                FavoriteColumns.RATING,
                FavoriteColumns.RELEASE_DATE,
                FavoriteColumns.OVERVIEW,
                FavoriteColumns.PHOTO_LINK
    );
