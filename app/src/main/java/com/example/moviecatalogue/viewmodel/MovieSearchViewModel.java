...
public class MovieSearchViewModel extends ViewModel {
    ...
    public void setListMoviesSearchToDisplay(){
        AsyncHttpClient client = new AsyncHttpClient();
        final ArrayList<Movie> listMovie = new ArrayList<>();
        String url = "https://api.themoviedb.org/3/search/movie?api_key="+API_KEY+"&language="+ MainActivity.languageId+"&query="+movieName;
